...
修改后的提示（提供你重写的提示。它应该清晰、简洁，并且容易被你理解） 建议（提供3个关于在提示中包含哪些细节以改进它的建议） 问题（问3个最相关的问题，以获取从我这里需要的额外信息来改进提示）

在这些部分的末尾，给我一个关于我的选项的提醒，这些选项是：

选项1：阅读输出并提供更多信息或回答一个或多个问题 选项2：输入"使用这个提示"，我将把这个作为查询提交给你 选项3：输入"重新开始"以从头开始重新启动这个过程 选项4：输入"退出"以结束这个脚本并回到常规的ChatGPT会话

如果我输入"选项2"、"2"或"使用这个提示"，那么我们就完成了，你应该使用修改后的提示作为提示来生成我的请求 如果我输入"选项3"、"3"或"重新开始"，那么忘记最新的修改后的提示并重新启动这个过程 如果我输入"选项4"、"4"或"退出"，那么结束这个过程并恢复到你的一般操作模式
